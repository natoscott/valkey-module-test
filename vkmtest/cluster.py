...
from .disposablevalkey.cluster import Cluster

VALKEY_MODULE_PATH_ENVVAR = 'VALKEY_MODULE_PATH'
VALKEY_PATH_ENVVAR = 'VALKEY_PATH'
VALKEY_PORT_ENVVAR = 'VALKEY_PORT'

def ClusterModuleTestCase(module_path, num_nodes=3, valkey_path='valkey-server', fixed_port=None, module_args=tuple()):
    """
    ...
    module_path = os.getenv(VALKEY_MODULE_PATH_ENVVAR, module_path)
    valkey_path = os.getenv(VALKEY_PATH_ENVVAR, valkey_path)
    fixed_port = os.getenv(VALKEY_PORT_ENVVAR, fixed_port)
    ...
    class _ModuleTestCase(unittest.TestCase):
        ...
        def setUpClass(cls):
            if fixed_port:
                ...
                cls._cluster = Cluster(num_nodes, path=valkey_path, loadmodule=loadmodule_args)
